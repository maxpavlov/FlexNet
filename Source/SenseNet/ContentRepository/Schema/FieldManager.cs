...
namespace  SenseNet.ContentRepository.Schema
{
	public static class FieldManager
	{
		...
		//TODO: RENAMEPROJECT: Accessor felulet
		...
		private static void Initialize()
		{
			lock (syncRoot)
			{
				if (!initialized)
				{
                    ...
                    foreach (var type in TypeHandler.GetTypesByBaseType(typeof(Field)))
                    {
					...
					foreach (var type in TypeHandler.GetTypesByBaseType(typeof(FieldSetting)))
