...
namespace SenseNet.ContentRepository.Schema
{
	public static class RepositorySchema
	{
		...
		public static Type[] ContentHandlers { get { return TypeHandler.GetTypesByBaseType(typeof(Node)); } }
		public static Type[] NodeObservers { get { return TypeHandler.GetTypesByBaseType(typeof(NodeObserver)); } }
		public static Type[] FieldTypes { get { return FieldManager.GetFieldTypes(); } }
		public static Type[] FieldSettingTypes { get { return TypeHandler.GetTypesByBaseType(typeof(FieldSetting)); } }
		...
		public static Type GetFieldTypeByShortName(string shortName)
		{
			...
			return TypeHandler.GetType(name);
		}
		...
		public static Type[] GetAvilableFieldSettingTypes(Type fieldType)
		{
			...
			types.AddRange(TypeHandler.GetTypesByBaseType(GetDefaultFieldSettingType(fieldType)));
