...
namespace  SenseNet.ContentRepository.Schema
{
	public class ContentTypeInstaller
	{
        ...
        //public static void InstallContentType(string contentTypeDefinitionXml)
        //{
        //    ContentType contentType = ContentTypeManager.LoadOrCreateNew(contentTypeDefinitionXml);
        //    SchemaEditor editor = new SchemaEditor();
        //    editor.Load();
        //    ContentTypeManager.ApplyChangesInEditor(contentType, editor);
        //    contentType.Save(false);
        //    ContentTypeManager.Current.AddContentType(contentType);
        //    editor.Register();
        //}
        //public static void InstallContentType(string contentTypeDefinitionXml, params string[] moreContentTypeDefinitionXmls)
        //{
        //    var installer = CreateBatchContentTypeInstaller();
        //    installer.AddContentType(contentTypeDefinitionXml);
        //    foreach (var s in moreContentTypeDefinitionXmls)
        //        installer.AddContentType(s);
