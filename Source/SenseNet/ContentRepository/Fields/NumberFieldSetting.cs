...
namespace SenseNet.ContentRepository.Fields
{
	public class NumberFieldSetting : FieldSetting
	{
	    ...
	    private void SetSlotMinMaxValues()
        {
            ...
            {
                _slotMinValue = ActiveSchema.DecimalMinValue; //Convert.ToDecimal(Single.MinValue);
                _slotMaxValue = ActiveSchema.DecimalMaxValue; //Convert.ToDecimal(Single.MaxValue);
            }
            else if (propertyType == typeof(Double))
            {
                _slotMinValue = ActiveSchema.DecimalMinValue; //Convert.ToDecimal(Double.MinValue);
                _slotMaxValue = ActiveSchema.DecimalMaxValue; //Convert.ToDecimal(Double.MaxValue);
            }
