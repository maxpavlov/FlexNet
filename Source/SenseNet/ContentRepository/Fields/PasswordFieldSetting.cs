...
namespace SenseNet.ContentRepository.Fields
{
    ...
    public class PasswordFieldSetting : ShortTextFieldSetting
    {
        ...
        public virtual PasswordCheckResult CheckPassword(string password, List<PasswordField.OldPasswordData> oldPasswords)
        {
            ...
            return CheckRecurrence(password, oldPasswords);

            //// default password check: every password is considered valid
            //return new PasswordCheckResult { Valid = true };
        }
        public virtual PasswordCheckResult CheckRecurrence(string password, List<PasswordField.OldPasswordData> oldPasswords)
        {
            return CheckRecurrence(password, oldPasswords, PasswordHistoryLength);
        }
        private PasswordCheckResult CheckRecurrence(string password, List<PasswordField.OldPasswordData> oldPasswords, int passwordHistoryLength)
        {
