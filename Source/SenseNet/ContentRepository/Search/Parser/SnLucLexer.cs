...
namespace SenseNet.Search.Parser
{
	internal class SnLucLexer
	{
		...
		public static class Keywords
		{
            ...
            {
                if (text == Select || text == Skip || text == Top || text == Sort || text == ReverseSort || text == Autofilters || text == Lifespan || text == CountOnly)
		...
		public enum Token
		{
            ...
            //------ Keywords ------
            ControlKeyword,  // SKIP, TOP, SORT, REVERSESORT, AUTOFILTERS
        ...
        //                return;
        //            }
        //            throw new ParserException("Unknown character: " + c, CreateCurrentLineInfo());
        //    }
        //}
        private void SetCharType()
        {
			...
			switch (this.CurrentChar)
			{
				...
				default:
                    ...
                    else
                    {
                        ...
                        if (keyword)
                            this.CurrentToken = Keywords.ScanControl(this.StringValue, CreateLastLineInfo()); //Token.Keyword;
                        else if (hasWildcard)
		...
		{
			while (this.CurrentCharType == CharType.WhiteSpace && NextChar()) ;
		}
