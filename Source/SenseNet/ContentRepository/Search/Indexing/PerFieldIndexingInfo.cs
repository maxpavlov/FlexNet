...
namespace SenseNet.Search.Indexing
{
    public class PerFieldIndexingInfo
    {
        ...
        public static readonly PerFieldIndexingInfo DefaultInfo = new PerFieldIndexingInfo
        {
            IndexingMode = DefaultIndexingMode,
            IndexStoringMode = DefaultIndexStoringMode,
            TermVectorStoringMode = DefaultTermVectorStoringMode,
        };
