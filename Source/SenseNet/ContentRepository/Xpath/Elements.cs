...
namespace SenseNet.ContentRepository.Xpath
{
    ...
    internal abstract class ElementBase
    {
        ...
        bool _firstChildCompleted;
        bool _siblingsCompleted;
    ...
    internal class ContentHeadElement : ElementBase
    {
        ...
        public override ElementBase CreateNextElement()
        {
            switch (Name)
            {
                //case "Name": return new ContentHeadElement(this.RootNavigator, "ContentType", this.Parent);
    ...
    {
        IEnumerator<Field> _wrappedEnumerator;
