...
namespace SenseNet.ContentRepository
{
	...
	public abstract partial class Field : IIndexableField
	{
		...
		public string Name
		{
			get { return this.FieldSetting.Name; }
		}
        /// <summary>
        ...
        internal void SetDefaultValue()
        {
            ...
            {
                Parse(FieldSetting.DefaultValue);
                this.Save(false);
            }
        }
		...
		{
			this.ValidationResult = null;
			this.ValidationResult = this.FieldSetting.Validate(_value, this);
			_isValidated = true;
        ...
        public bool IsInIndex { get { return this.FieldSetting.IndexingInfo.IsInIndex; } }
        public virtual IEnumerable<IndexFieldInfo> GetIndexFieldInfos(out string textExtract)
        {
            return this.FieldSetting.IndexingInfo.IndexFieldHandler.GetIndexFieldInfos(this, out textExtract);
        }
		...
		{
			return new NotImplementedException(String.Concat(
				"Export is not implemented. Content: ", this.Content.Path,
				", Field: ", this.Name,
				", FieldType: ", this.FieldSetting.ShortName));
		}
		protected Exception ExportNotImplementedException(object notImplementedValue)
		{
			throw new NotImplementedException(String.Concat(
				"Export is not implemented. Content: ", this.Content.Path,
				", Field: ", this.Name,
				", FieldType: ", this.FieldSetting.ShortName,
				", field value type: ", notImplementedValue.GetType().FullName));
		}
        ...
        {
            writer.WriteString(Convert.ToString(GetData(), System.Globalization.CultureInfo.InvariantCulture));
        }
