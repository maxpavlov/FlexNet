...
<div class="sn-listview">
    <sn:Toolbar runat="server">
        ...
        <sn:ToolbarItemGroup runat="server" Align="Right">
            <sn:ActionMenu runat="server" IconUrl="/Root/Global/images/icons/16/settings.png" Scenario="VotingSettings" ContextInfoID="myList" CheckActionCount="True">Settings</sn:ActionMenu>
