...
<asp:Repeater ID="PageRepeater" runat="server" OnItemDataBound="Repeater_OnItemDataBound" OnItemCommand="Repeater_OnItemCommand">
    <HeaderTemplate>
        <asp:LinkButton ID="lnkFirst" CssClass="SNPager_FirstPage sn-pager-first ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only" runat="server" 
        CommandName="PageFirst">
            <span class="ui-button-icon-primary ui-icon ui-icon-seek-start"></span>
