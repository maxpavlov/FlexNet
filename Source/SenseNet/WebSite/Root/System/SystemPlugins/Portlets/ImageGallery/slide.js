    ...
    return {
        ...
        getimg: function(id) {
            ...
            if (!document.getElementById(id)) {
                ...
                var g = document.getElementById('sn-gallery-description');
                lin.appendChild(i);
                ...
                g.innerHTML = '<h2 class="snImageTitle">' + snGalleryTitleArray[id] + ' (' + id + '/' + (snGalleryImageArray.length - 1) + ')</h2><div class="sn-image-description">' + snGalleryDescArray[id] + '</div>';
            } else {
