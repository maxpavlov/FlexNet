    ...
    <controltemplate>
                <asp:PlaceHolder ID="DialogHeader" runat="server">
                    ...
                    <p class="sn-lead sn-dialog-lead">
                        <asp:Label ID="DeleteOneLabel" runat="server" Text="You are about to delete the contents above." /> 
                    </p>
                    ...
                    <asp:CheckBox style="display:block; margin-top:10px;" CssClass="sn-warning-msg" runat="server" ID="PermanentDeleteCheckBox" Text="<span class='sn-icon-small sn-icon-button snIconSmall_error'></span>By checking this box, you choose to permanently delete content, instead of moving them to the trash." Visible="false" />
