...
namespace SenseNet.Services.ContentStore
{
    ...
    public interface IContentStoreService
    {
        ...
        //[OperationContract]
        //[WebGet(ResponseFormat = WebMessageFormat.Json, UriTemplate = "/GetItem?node={path}")]
        //[FaultContract(typeof(NodeLoadException))]
        //Content GetItem(string path);
        ...
        //[OperationContract]
        //[WebGet(ResponseFormat = WebMessageFormat.Json, UriTemplate = "/GetFeed?node={path}")]
        //[FaultContract(typeof(NodeLoadException))]
        //Content[] GetFeed(string path);
