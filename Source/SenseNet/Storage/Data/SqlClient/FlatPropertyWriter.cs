...
namespace SenseNet.ContentRepository.Storage.Data.SqlClient
{
    internal class FlatPropertyWriter
    {
        ...
        Dictionary<int, Dictionary<string, SqlParameter>> _values = new Dictionary<int, Dictionary<string, SqlParameter>>(); // page, property, value

        public FlatPropertyWriter(int versionId)
        {
            _versionId = versionId;
            //_pageWriters = new Dictionary<int, SqlProcedure>();
            //_existingPages = GetExistingFlatPages(versionId);
        }
