...
namespace SenseNet.ContentRepository.Storage
{
	public static class MimeTable
	{
		...
		{
			string[] mimes;
            string pureExtension = fileExtension.StartsWith(".", StringComparison.Ordinal) ? fileExtension.Substring(1) : fileExtension;

            if (_mimeByExtension.TryGetValue(pureExtension, out mimes))
				return mimes;
