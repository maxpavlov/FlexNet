		...
		private class TimerThread:Support.ThreadClass
		{
			...
			override public void  Run()
			{
				while (true)
				{
					...
					time += Lucene.Net.Search.TimeLimitedCollector.resolution;
					try
					{
						System.Threading.Thread.Sleep(new System.TimeSpan((System.Int64) 10000 * Lucene.Net.Search.TimeLimitedCollector.resolution));
					}
