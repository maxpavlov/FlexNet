...
{
	/// <summary>
	///This is a test class for SenseNet.ContentRepository.Storage.ActiveSchema and is intended
	///to contain all SenseNet.ContentRepository.Storage.ActiveSchema Unit Tests
	///</summary>
	[TestClass()]
    public class ActiveSchemaTest : TestBase
	{
