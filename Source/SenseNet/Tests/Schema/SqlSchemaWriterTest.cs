...
namespace SenseNet.ContentRepository.Tests.Schema
{
    ...
    public class SqlSchemaWriterTest : TestBase
	{
		...
		//    {
		//        MethodInfo info = _type.GetMethod(name, BindingFlags.NonPublic | BindingFlags.Instance);
		//        return info.Invoke(_target, parameters);
		//    }
		//    protected object CallPrivateStaticMethod(string name, params object[] parameters)
		//    {
		...
		public void SqlSchemaWriter_RemovePropertyTypeFromNodeType_Binary()
		{
			...
			string expectedSql = @"
						-- Reset property value: NT0.PT0:Binary
